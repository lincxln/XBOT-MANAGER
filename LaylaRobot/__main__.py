...
i'm a group manager bot. Maintained by @xxxjahsehd ❤
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [
                         InlineKeyboardButton(
                             text="Support Group",
                             url=f"https://t.me/xxxjahsehdchat"),
                         InlineKeyboardButton(
                             text="📘 Logs",
                             url="https://t.me/xxxjahsehd_bot")
                     ],
                     [
                         InlineKeyboardButton(
                             text="☑️ Source code",
                             url="https://github.com/lincxln/XBOT-MANAGER")
                     ]]))
    else:
